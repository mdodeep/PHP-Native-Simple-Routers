            ...
            <div class="card-body">
                <div class="card-text">
                    ...
                    <div class="avatar avatar-2xl">
                        <img src="<?php echo APP_ASSETS_PATH; ?>compiled/jpg/2.jpg" alt="Avatar">
                    </div>
                    </p>
                    <?php if (isset($getName) && isset($getEmail)) { ?>
                        <p style="line-height: 6px;">Name : <?php echo $getName; ?></p>
                        <p style="line-height: 6px;">Email : <?php echo $getEmail; ?></p>
                    <?php } else { ?>
                        <p>Data not found</p>
                    <?php } ?>
                </div>
