            ...
            <div class="card-body">
                <div class="card-text">
                    ...
                    <div class="d-flex flex-row">
                        <div class="pe-1"><a href="<?php routeTo('page-1'); ?>" class="btn btn-primary btn-sm active">Page 1</a></div>
                        <div class="pe-1"><a href="<?php routeTo('page-2'); ?>" class="btn btn-success btn-sm">Page 2</a></div>
